...
async def on_message(message): 
    ...
    if "dale" in message.content.lower(): 
        await message.channel.send('https://cdn.discordapp.com/attachments/1173495961419522081/1375507194107133973/CLIP_LowTierGod_Gets_Heated_By_Being_Called_His_Government_Name.mp4?ex=6831f066&is=68309ee6&hm=cd74a48008e74ff716cb6add27fa04e16d75cf171d8bdca9c5e1f7aafde3cfad&')
